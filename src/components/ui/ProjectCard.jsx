...
export default function ProjectCard({ project, index }) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl overflow-hidden glass gradient-border cursor-pointer"
    >
      {/* Image with overlay */}
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <a
            ...
            className="flex items-center gap-2 text-sm font-medium text-slate-400 hover:text-accent transition-colors"
          >
